...
namespace CompanyBankAccountsApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<CompanyBankAccountsDB>(options =>
            ...
            services.AddScoped<CompanyHoldingRepository>();
            services.AddScoped<BankAccountRepository>();
            services.AddScoped<UserMap>();
            services.AddScoped<CompanyHoldingMap>();
            services.AddScoped<BankAccountMap>();
            services.AddScoped<AuthService>();
            services.AddScoped<UserService>();
            services.AddScoped<CompanyHoldingService>();
